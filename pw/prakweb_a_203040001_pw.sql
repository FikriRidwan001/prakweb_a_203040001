...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=64418671ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=prakweb_a_203040001_pw&table=buku">`prakweb_a_203040001_pw`.`buku`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=alat_medis">`test`.`alat_medis`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=user">`test`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=tenaga_medis">`test`.`tenaga_medis`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=sertifikat">`test`.`sertifikat`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=pasien">`test`.`pasien`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=jenis_vaksin">`test`.`jenis_vaksin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=smbd&table=transaksi">`smbd`.`transaksi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=smbd&table=sparepart">`smbd`.`sparepart`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=smbd&table=administrasi">`smbd`.`administrasi`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2f5c3d283e4e7a40423043234322677a">
